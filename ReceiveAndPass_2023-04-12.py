# File:     ReceiveAndPass_2023-04-12
# Version:  0.0.01
# Author:   Susan Haynes
# Comments/Notes:
...
lbl_out_s1 = tk.Label(GUI, text="minecraft Output").place(x=475, y=135,anchor='w')
...
def minecraft():
############ OPEN NEW minecraft GUI   ###################
    print("minecraft will be here soon")

btn_no1 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no1.place(x=250, y=120)
btn_no2 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no2.place(x=250, y=160)
btn_no3 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no3.place(x=250, y=200)
btn_no4 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no4.place(x=250, y=240)
btn_no5 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no5.place(x=250, y=280)
btn_no6 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no6.place(x=250, y=320)
btn_no7 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no7.place(x=250, y=360)
btn_no8 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no8.place(x=250, y=400)
btn_no9 = tk.Button(GUI, text='No', width=5, command=minecraft)
btn_no9.place(x=250, y=440)
btn_no10 = tk.Button(GUI, text='No', width=5, command=minecraft)
